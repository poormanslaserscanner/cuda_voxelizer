...
inline char checkVoxel(size_t x, size_t y, size_t z, size_t gridsizex, size_t gridsizey, size_t gridsizez, const unsigned int* vtable){
	size_t location = x + (y*gridsizex) + (z*gridsizex*gridsizey);
	assert(x < gridsizex && y < gridsizey && z < gridsizez);
